...
def generate_launch_description():
    return LaunchDescription([
        Node(
            ...
            name="motor_controller_69a63afd1c25c752f21c8372",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63afd1c25c752f21c8372",
                ...
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b261c25c752f21c83a9","source_node_id":"69a63b221c25c752f21c83a2","source_pin_id":"rear_left_motor","target_pin_id":"command"}]')),
        ...
        Node(
            package="motor_controller",
            executable="motor_controller_node",
            name="motor_controller_69a63b131c25c752f21c8390",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b131c25c752f21c8390",
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"motor_0","control_mode":"velocity","max_speed":1}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3cd62b3f393789aad70a2:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"},{"pin_id":"69a3cd62b3f393789aad70a2:state","name":"state","direction":"output","msg_type":"polyflow_msgs/MotorState"}]')),
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b251c25c752f21c83a6","source_node_id":"69a63b221c25c752f21c83a2","source_pin_id":"front_left_motor","target_pin_id":"command"}]')),
                "POLYFLOW_OUTBOUND_CONNECTIONS": json.dumps(json.loads('[]')),
            }
        ),
        Node(
            package="motor_controller",
            executable="motor_controller_node",
            name="motor_controller_69a63b181c25c752f21c8396",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b181c25c752f21c8396",
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"motor_0","control_mode":"velocity","max_speed":1}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3cd62b3f393789aad70a2:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"},{"pin_id":"69a3cd62b3f393789aad70a2:state","name":"state","direction":"output","msg_type":"polyflow_msgs/MotorState"}]')),
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b281c25c752f21c83ac","source_node_id":"69a63b221c25c752f21c83a2","source_pin_id":"front_right_motor","target_pin_id":"command"}]')),
                "POLYFLOW_OUTBOUND_CONNECTIONS": json.dumps(json.loads('[]')),
            }
        ),
        Node(
            package="motor_controller",
            executable="motor_controller_node",
            name="motor_controller_69a63b1b1c25c752f21c839c",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b1b1c25c752f21c839c",
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"motor_0","control_mode":"velocity","max_speed":1}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3cd62b3f393789aad70a2:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"},{"pin_id":"69a3cd62b3f393789aad70a2:state","name":"state","direction":"output","msg_type":"polyflow_msgs/MotorState"}]')),
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b291c25c752f21c83af","source_node_id":"69a63b221c25c752f21c83a2","source_pin_id":"rear_right_motor","target_pin_id":"command"}]')),
                "POLYFLOW_OUTBOUND_CONNECTIONS": json.dumps(json.loads('[]')),
            }
        ),
        Node(
            ...
            name="differential_drive_69a63b221c25c752f21c83a2",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b221c25c752f21c83a2",
                ...
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b3f1c25c752f21c83d4","source_node_id":"69a63b3c1c25c752f21c83d0","source_pin_id":"encoder_state","target_pin_id":"encoder_right"},{"connection_id":"69a63b431c25c752f21c83d7","source_node_id":"69a63b381c25c752f21c83ca","source_pin_id":"encoder_state","target_pin_id":"encoder_left"},{"connection_id":"69a63b441c25c752f21c83da","source_node_id":"69a63b321c25c752f21c83bf","source_pin_id":"mode","target_pin_id":"mode"},{"connection_id":"69a63b461c25c752f21c83dd","source_node_id":"69a63b2e1c25c752f21c83b9","source_pin_id":"cmd_vel","target_pin_id":"cmd_vel"},{"connection_id":"69a63b481c25c752f21c83e0","source_node_id":"69a63b2c1c25c752f21c83b4","source_pin_id":"cmd_vel","target_pin_id":"cmd_vel"}]')),
                "POLYFLOW_OUTBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b251c25c752f21c83a6","target_node_id":"69a63b131c25c752f21c8390","source_pin_id":"front_left_motor","target_pin_id":"command"},{"connection_id":"69a63b261c25c752f21c83a9","target_node_id":"69a63afd1c25c752f21c8372","source_pin_id":"rear_left_motor","target_pin_id":"command"},{"connection_id":"69a63b281c25c752f21c83ac","target_node_id":"69a63b181c25c752f21c8396","source_pin_id":"front_right_motor","target_pin_id":"command"},{"connection_id":"69a63b291c25c752f21c83af","target_node_id":"69a63b1b1c25c752f21c839c","source_pin_id":"rear_right_motor","target_pin_id":"command"}]')),
            }
        ),
        Node(
            package="gamepad",
            executable="gamepad_node",
            name="gamepad_69a63b2c1c25c752f21c83b4",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b2c1c25c752f21c83b4",
                ...
                "POLYFLOW_OUTBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b481c25c752f21c83e0","target_node_id":"69a63b221c25c752f21c83a2","source_pin_id":"cmd_vel","target_pin_id":"cmd_vel"}]')),
            }
        ),
        Node(
            package="mission_runner",
            executable="mission_runner_node",
            name="mission_runner_69a63b2e1c25c752f21c83b9",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b2e1c25c752f21c83b9",
                ...
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[]')),
                "POLYFLOW_OUTBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b461c25c752f21c83dd","target_node_id":"69a63b221c25c752f21c83a2","source_pin_id":"cmd_vel","target_pin_id":"cmd_vel"}]')),
            }
        ),
        Node(
            package="mode_switcher",
            executable="mode_switcher_node",
            name="mode_switcher_69a63b321c25c752f21c83bf",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b321c25c752f21c83bf",
                ...
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[]')),
                "POLYFLOW_OUTBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b441c25c752f21c83da","target_node_id":"69a63b221c25c752f21c83a2","source_pin_id":"mode","target_pin_id":"mode"}]')),
            }
        ),
        Node(
            package="logger",
            executable="logger_node",
            name="logger_69a63b361c25c752f21c83c5",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b361c25c752f21c83c5",
        ...
        Node(
            ...
            name="optical_encoder_69a63b381c25c752f21c83ca",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b381c25c752f21c83ca",
                ...
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[]')),
                "POLYFLOW_OUTBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b431c25c752f21c83d7","target_node_id":"69a63b221c25c752f21c83a2","source_pin_id":"encoder_state","target_pin_id":"encoder_left"}]')),
            }
        ),
        Node(
            package="optical_encoder",
            executable="optical_encoder_node",
            name="optical_encoder_69a63b3c1c25c752f21c83d0",
            output="screen",
            additional_env={
                "POLYFLOW_NODE_ID": "69a63b3c1c25c752f21c83d0",
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"encoder_id":"encoder_0","ticks_per_rev":1024,"publish_rate_hz":50}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3c932b3f393789aad6fbc:reset","name":"reset","direction":"input","msg_type":"std_msgs/Empty"},{"pin_id":"69a3c932b3f393789aad6fbc:encoder_state","name":"encoder_state","direction":"output","msg_type":"polyflow_msgs/EncoderState"}]')),
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[]')),
                "POLYFLOW_OUTBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69a63b3f1c25c752f21c83d4","target_node_id":"69a63b221c25c752f21c83a2","source_pin_id":"encoder_state","target_pin_id":"encoder_right"}]')),
            }
        ),
    ])